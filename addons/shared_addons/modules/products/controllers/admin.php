...
class Admin extends Admin_Controller{
    ...
    public function index()
    {
        ...
        $extra['columns'] = array('p_id', 'p_name', 'p_price','p_image', 'p_short_description', 'category_id');
        ...
        $this ->streams->cp->entries_table('products', 'products', 5, 'admin/products/index', true, $extra);
    }
