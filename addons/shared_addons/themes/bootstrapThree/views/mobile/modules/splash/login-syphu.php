<?php if ($location_detail['layout']['value'] == "fullsize"):?>
	...
	<div id="container-bottom-0" class="container">
		<div class="row">
				<div id="modal-login-btn" class="col-xs-5 col-sm-4">												
					...
					<?php else: ?>
						...
						<?php else:?>
							<a class="<?php if (isset($location_detail['login_button_class'])) {echo $location_detail['login_button_class'];}else{echo "btn azm-social btn-block azm-btn-40 azm-medium azm-gradient";}?>" data-toggle="modal" data-target="#modal-transparent">
...
<script>
	...
	function blinker() {
   	 $('#sw-copyright').fadeOut(3000).fadeIn(3000);
	}
